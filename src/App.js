...
export default function App() {
    ...
    const [locationData, setLocationData] = React.useState({
        ...
        photo:
            "https://lh5.googleusercontent.com/p/AF1QipMVgkpts6tYntPJCUivvWnq6KSth4ZqboHbwm1R=w426-h240-k-no",
    });
    ...
    useEffect(() => {
        ...
        window.navigator.geolocation.getCurrentPosition((pos) => {
            ...
            // I hate cors~ 
            // since we're not doing sererside stuff we have to do
            // some weird client code to use googles api
            var map;
            var service;
    ...
    return !isLoading ? (
        <div className="container-loaded">
            <h1>
                Go eat <span className="text-highlight ">at:</span>
            </h1>
            {/** */}
            <Place
        ...
        <div className="container">
            <h1>
                Go eat <span className="text-highlight loading">at</span>
            </h1>
        </div>
    );
}
